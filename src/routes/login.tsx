...
//   - magic   : lien magique sans mot de passe (alternative reléguée)
//
// L'utilisateur arrive par défaut sur "login". Pas encore inscrit ? Lien
// proéminent vers "signup". Magic link disponible mais discret en bas de page
// pour les habitués / users historiques sans mot de passe.
...
function Login() {
  ...
  const onSignup = async (e: React.FormEvent) => {
    ...
    if (data?.user && !data.session) {
      ...
      // Auto-confirmé (config Supabase) → redirection auto
...
/* ============================================================================
 * Magic link form (alternative tertiary)
 * ========================================================================== */
...
function MagicForm({
  ...
  return (
    <>
      ...
      <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
        Pour les utilisateurs sans mot de passe. Cliquez le lien dans l'email
        reçu pour vous connecter sans rien retenir.
      </p>
      <form onSubmit={onSubmit} className="mt-6 space-y-4">
        <EmailField value={email} onChange={setEmail} />
        <Button
...
/* ============================================================================
 * Email / Password fields (réutilisables)
 * ========================================================================== */
...
function PasswordField({
  ...
  // Un id unique par usage (login password / signup password / confirm) évite
  // les warnings d'accessibilité quand plusieurs champs coexistent.
...
/* ============================================================================
 * Success panel (après envoi d'email)
 * ========================================================================== */
